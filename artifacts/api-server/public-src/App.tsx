...
const FLOW_QUESTIONS: Record<FlowType, Question[]> = {
  conversation: [
    { id: "who", label: "Who is this conversation with?", type: "choice", options: ["My manager","A peer or colleague","Someone I manage","A client or stakeholder","HR or senior leadership"] },
    { id: "topic", label: "What is the conversation about?", type: "choice", options: ["Performance or feedback","A boundary or behaviour","Workload or resources","Conflict or tension","Career or role expectations"] },
    { id: "feeling", label: "How are you feeling going into it?", type: "choice", options: ["Anxious about their reaction","Unsure how to start","Worried it will damage the relationship","Frustrated but holding back","Clear on what I need to say"] },
    { id: "goal", label: "What does a successful conversation look like?", type: "choice", options: ["They understand my perspective","We agree on a clear change","The relationship stays intact","I say what I need to say","We reach a decision together"] },
  ],
  stuck: [
    { id: "root_cause", label: "What is making you feel stuck?", type: "choice", options: ["I do not know what I want next","I know what I want but not how to get there","Something external is blocking me","I keep talking myself out of it","I am waiting for the right moment"] },
    { id: "strengths", label: "What do you know you are good at?", type: "multiselect", maxSelect: 3, options: ["Leading people or teams","Strategic thinking","Technical or specialist expertise","Building relationships","Communicating and influencing","Delivering results under pressure"] },
    { id: "wants", label: "What matters most to you in your next move?", type: "multiselect", maxSelect: 3, options: ["More seniority or title","Higher income","Greater autonomy","More meaningful work","Better culture or environment","A new challenge or industry"] },
    { id: "directions", label: "Which direction feels most alive right now?", type: "multiselect", maxSelect: 2, options: ["Move up in my current organisation","Move into a different company","Change industries or functions","Build something of my own","Take time to figure it out"] },
    { id: "success", label: "What would tell you that you have broken through?", type: "choice", options: ["I have made a decision and I am acting on it","I have a clear plan with a timeline","I have had the conversation I have been avoiding","I have applied for or pursued something new","I feel clear instead of stuck"] },
  ],
  speak_up: [
    { id: "blocker", label: "What stops you from speaking up?", type: "choice", options: ["I worry my point will not land well","I do not want to seem aggressive or difficult","Someone always speaks before I can","I doubt whether my view adds value","I wait too long and the moment passes"] },
    { id: "pattern", label: "When does this happen most?", type: "choice", options: ["In large group meetings","With senior leaders in the room","When I disagree with what is being said","When I have an idea but am not sure it is ready","When the conversation moves too fast"] },
    { id: "meeting_type", label: "What type of meeting matters most to you right now?", type: "choice", options: ["Team meetings","Leadership or executive meetings","Cross-functional meetings","One-on-ones with my manager","Client or stakeholder meetings"] },
    { id: "cost", label: "What is the cost of staying silent?", type: "choice", options: ["My ideas do not get heard","Others get credit for directions I shaped","I am not seen as a leader","I feel frustrated with myself after","The team misses my perspective"] },
  ],
  executive_visibility: [
    { id: "challenge", label: "What is your visibility challenge?", type: "choice", options: ["My work is not being recognised at the right level","I am seen as an executor not a strategic thinker","I do not know how to position myself with senior leaders","My results are strong but they are not translating to opportunity","I am not in the right rooms or conversations"] },
    { id: "audience", label: "Who do you most need to be visible to?", type: "choice", options: ["My direct manager","Senior leaders two levels above me","Cross-functional peers and stakeholders","The broader organisation","External industry networks"] },
    { id: "medium", label: "Where do you have the most opportunity to shift perception?", type: "choice", options: ["In meetings and presentations","In written updates and reports","In one-on-one conversations","In how I talk about my work","In the relationships I am building"] },
    { id: "gap", label: "What is the gap between how you see your work and how others see it?", type: "choice", options: ["I deliver but do not communicate impact","I communicate but to the wrong audience","I am known for one thing but want to be known for more","My contributions are visible but not valued","I am not sure how I am perceived"] },
  ],
  negotiate: [
    { id: "situation_type", label: "What are you negotiating?", type: "choice", options: ["A salary increase","A promotion","Additional scope or resources","A role change or new opportunity","Terms of an offer"] },
    { id: "what", label: "Where are you in the process?", type: "choice", options: ["I have not started the conversation yet","I have raised it and am waiting","They have come back with a response","I have been rejected once already","I am preparing for a formal review"] },
    { id: "timing", label: "What is driving the timing?", type: "choice", options: ["Annual review cycle","I have been in the role long enough","I have taken on more than my role","A competing offer or opportunity","A specific achievement or result"] },
    { id: "target", label: "How clear are you on what you want?", type: "choice", options: ["Very clear — I know the number and the ask","Mostly clear but unsure how to frame it","I know the range but not the anchor","I am not sure what is realistic","I need to understand my market value first"] },
    { id: "leverage", label: "What is your strongest leverage?", type: "choice", options: ["Strong recent results or delivery","Market rate data","A competing offer","Critical knowledge or relationships","Loyalty and track record"] },
    { id: "fear", label: "What is your biggest concern?", type: "choice", options: ["They will say no and nothing will change","It will damage the relationship","I will not know how to respond to pushback","I am asking for too much","I will accept less than I deserve"] },
  ],
  mindset: [
    { id: "feeling", label: "What are you experiencing right now?", type: "choice", options: ["Overwhelmed by how much there is to do","Paralysed and not able to start","Comparing myself to others and losing","Knocked by feedback or a setback","Doubting whether I am good enough"] },
    { id: "trigger", label: "What triggered this?", type: "choice", options: ["A specific event or conversation","Ongoing pressure building up","Seeing someone else succeed","Feedback I received","Nothing specific — it has been building"] },
    { id: "pattern", label: "What does your inner voice say most?", type: "choice", options: ["I am not ready for this","Everyone else has it together","I should be further along by now","What if I fail","I do not deserve to be here"] },
  ],
};
