...
export const flows: Record<string, FlowStep[]> = {
  ...
  speak_up: [
    ...
    {
      key: "pattern",
      question: "What happens in the moment?",
      options: [
        "I start to speak, then pull back at the last second",
        "I wait for the perfect entry point — it never comes",
        "Someone else says my point while I'm still composing it",
    ...
    },
    {
      ...
      options: [
        ...
        "I'm not seen as a strategic contributor",
        "The conversation moves in the wrong direction",
